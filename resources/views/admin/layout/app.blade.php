...
<body>
                ...
                <div class="user">
                    ...
                    <div class="info">
                        ...
                        <div class="collapse" id="collapseExample">
                            <ul class="nav">
                                <li>
                                    <a href="grid.html#">My Profile</a>
                                </li>
                                <li>
                                    <a href="grid.html#">Edit Profile</a>
                                </li>
                                <li>
                                    <a href="grid.html#">Settings</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a href="grid.html#pablo" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="grid.html#">Mike John responded to your email</a>
                                    </li>
                                    <li>
                                        <a href="grid.html#">You have 5 new tasks</a>
                                    </li>
                                    <li>
                                        <a href="grid.html#">You're now friend with Andrew</a>
                                    </li>
                                    <li>
                                        <a href="grid.html#">Another Notification</a>
                                    </li>
                                    <li>
                                        <a href="grid.html#">Another One</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
    ...
    <div class="fixed-plugin">
        <div class="dropdown show-dropdown">
            <a href="grid.html#" data-toggle="dropdown">
